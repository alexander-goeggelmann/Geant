...
class ECHo_ActionInitialization : public G4VUserActionInitialization
{
    public:
        ...
        G4String GetDelimiter() const {return delimiter;}
    ...
    private:
        ...
        const G4String root_path = "/mnt/i/Simulations/";
        //const G4String root_path = "/media/sf_ECHoData/Simulations/";
        //const G4String root_path = "I:\\Simulations\\";
        G4String date_path;
        G4String event_path;
        G4String prims_path;
        //G4String pos_path;
