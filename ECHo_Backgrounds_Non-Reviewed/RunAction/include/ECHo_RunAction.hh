...
class ECHo_RunAction : public G4UserRunAction
{
    public:
            ...
            int32_t origin)
        {
            ...
            //event_veto.push_back((uint8_t) veto);
        }
        ...
        //void SetSubPVector(uint32_t number, uint64_t energy, uint8_t volume)
        //{
        //    subp_event_number.push_back(number);
        //    subp_energy.push_back(energy);
        //    subp_volume.push_back(volume);
        //}

        //void SetSubSubPVector(uint32_t number, uint64_t energy, uint8_t volume)
        //{
        //    subsubp_event_number.push_back(number);
        //    subsubp_energy.push_back(energy);
        //    subsubp_volume.push_back(volume);
        //}
        ...
        //void ClearSubPVector()
        //{
        //    subp_event_number.clear();
        //    subp_energy.clear();
        //    subp_volume.clear();
        //}

        //void ClearSubSubPVector()
        //{
        //    subsubp_event_number.clear();
        //    subsubp_energy.clear();
        //    subsubp_volume.clear();
        //}
        ...
        //G4int GetSubPLength() {return subp_event_number.size();}
        //G4int GetSubSubPLength() {return subsubp_event_number.size();}
    ...
    private:
        ...
        //std::vector<uint32_t> subp_event_number;
        //std::vector<uint32_t> subsubp_event_number;
        //std::vector<uint64_t> subp_energy;
        //std::vector<uint64_t> subsubp_energy;
        //std::vector<uint8_t> subp_volume;
        //std::vector<uint8_t> subsubp_volume;
