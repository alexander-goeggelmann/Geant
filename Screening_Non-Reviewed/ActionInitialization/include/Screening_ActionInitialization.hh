/// \file Screening_ActionInitialization.hh
/// \brief Definition of the Screening_ActionInitialization class

#ifndef Screening_ActionInitialization_h
#define Screening_ActionInitialization_h 1
...
class Screening_ActionInitialization : public G4VUserActionInitialization
{
    public:
        Screening_ActionInitialization(
            Screening_DetectorConstruction*, G4int, G4int, G4String, G4String);
        virtual ~Screening_ActionInitialization() {};
        ...
        void AddMessage(const G4String mes) {message += mes;}
    ...
    private:
        ...
        const G4String root_path = "/media/sf_ECHoData/ScreeningSimulations/";
        G4String date_path;
        G4String event_path;
        G4String prims_path;
        G4String pos_path;
