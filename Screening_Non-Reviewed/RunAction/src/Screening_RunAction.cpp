#include "../include/Screening_RunAction.hh"
...
void Screening_RunAction::BeginOfRunAction(const G4Run* run)
{
...
void Screening_RunAction::EndOfRunAction(const G4Run* run)
{
...
void Screening_RunAction::SaveEvent()
{
    std::ofstream myFile;
...
void Screening_RunAction::SavePrims()
{
    std::ofstream myFile;
...
void Screening_RunAction::SavePos()
{
    std::ofstream myFile;
