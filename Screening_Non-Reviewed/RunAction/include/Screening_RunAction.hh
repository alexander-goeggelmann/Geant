/// \file Screening_RunAction.hh
/// \brief Definition of the Screening_RunAction class

#ifndef Screening_RunAction_h
#define Screening_RunAction_h 1
...
class Screening_RunAction : public G4UserRunAction
{
    public:
        Screening_RunAction(const Screening_ActionInitialization* init) : G4UserRunAction(),
            fInit(init)
        {
            ClearEventVector();
            ClearStepVector();
    ...
    private:
        const Screening_ActionInitialization* fInit;
        G4int num_of_events;
