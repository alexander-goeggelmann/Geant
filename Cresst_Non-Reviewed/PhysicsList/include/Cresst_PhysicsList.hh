#ifndef Cresst_PhysicsList_h
#define Cresst_PhysicsList_h 1
...
/**
    \file Cresst_PhysicsList.hh
    Definition of the physics, which should be activated.
*/
class Cresst_PhysicsList: public G4VModularPhysicsList
{
    public:
        Cresst_PhysicsList() {};
        virtual ~Cresst_PhysicsList()
        {
            delete decayList;
            delete emList;
            delete raddecayList;
