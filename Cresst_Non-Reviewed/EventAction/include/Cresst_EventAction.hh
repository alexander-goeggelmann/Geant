/// \file Cresst_EventAction.hh
/// \brief Definition of the Cresst_EventAction class

#ifndef Cresst_EventAction_h
#define Cresst_EventAction_h 1
...
class Cresst_EventAction : public G4UserEventAction
{
    public:
        Cresst_EventAction(Cresst_RunAction *runAction) : G4UserEventAction(),
            fRunAction(runAction) {};
        virtual ~Cresst_EventAction() {};
